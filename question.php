...
if(isset($_POST['login'])){
	...
	if($log['answer'] == $answer){
		$message =  '<font color="#00F">Security Question Answered Correctly<b>!</b> Please wait...</font>';
		?><script>setInterval("redirects()", 5000);</script><?php
		} 
	else 	 $message =  '<font color="#F00">Wrong Security Answer <b>!</b></font>';		
...
<table width="100%">
<tr><td></td>
<td valign="top" style="padding-bottom:50px; color:#2F5E5E"><strong>SECURITY QUESTION</strong></td></tr>
<tr><td></td><td><strong><?=$message?></strong></td></tr>
<tr>
<td><strong>QUESTION</strong></td>
<td><?php echo $log['question'];?></td>
</tr>
<tr>
<td><strong>ANSWER</strong></td>
<td><input type="text" name="answer" style="height:30px; width:50%; border-radius:0px 10px 0px 10px;"  placeholder="Security Answer" required oninvalid="setCustomValidity('Pls Enter Your Answer! ')"
